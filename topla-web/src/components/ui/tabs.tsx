...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center gap-0 border-b border-border bg-transparent p-0 text-muted-foreground",
      className
    )}
    {...props}
  />
