...
import { setAuthCookies, setAccessCookie, clearAuthCookies, extractRefreshToken } from '../../utils/cookie.js';
...
export async function adminRoutes(app: FastifyInstance) {
  ...
  app.post('/auth/admin/login', async (request, reply) => {
    ...
    // Rate limiting: 20 urinish / 30 daqiqa
  ...
  app.post('/auth/admin/google', async (request, reply) => {
    ...
    // Verify Google ID token via Google tokeninfo endpoint (no extra package needed)
