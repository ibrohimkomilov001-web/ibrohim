...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'uz': {
      ...
      'seller_page': 'Sotuvchidan so\'rash',
      'cash': 'Naqd pul',
      'card': 'Plastik karta',
      ...
      'currency_som': 'so\'m',
      'high_rating': 'Yuqori reyting',
      'delivery_point': 'Topshirish punktiga',
      'self_pickup': 'Olib ketish',
      'price_som': 'Narxi, so\'m',
      'from_price': 'dan',
      'to_price': 'gacha',
      'delivery_period': 'Yetkazish muddati',
      'delivery_method_title': 'Yetkazish usuli',
      'up_to_3_days': '3 kungacha',
      'up_to_7_days': '7 kungacha',
      'not_important': 'Muhim emas',
      'brand': 'Brend',
      'brands_plural': 'Brendlar',
      'all_items': 'Barchasi',
      'color_label': 'Rang',
      'size_label': 'O\'lcham',
      'original': 'Original',
      'discounted': 'Chegirmali',
      'image_search': 'Rasm orqali qidirish',
      'image_search_error': 'Rasm orqali qidirish xatolik yuz berdi',
      'empty_favorites_title': 'Sizda hozircha sevimli\nmahsulotlar yo\'q',
      'empty_favorites_subtitle':
          'Katalogda yurakcha tugmasini bosish orqali tovarlar qo\'shishingiz mumkin',
      'empty_favorites_action': 'Mahsulotlarni ko\'rish',
      'promo_activated': 'Promokod faol!',
      'promo_use_at_order': 'Buyurtma berishda ishlating.',
      'discount_label': 'chegirma',
      'take_photo': 'Kameradan suratga olish',
      'choose_gallery': 'Galereyadan tanlash',
      'show_products': 'Tovarlarni ko\'rsatish',
      ...
      'faq_a5':
          'Naqd pul, UzCard, Humo yoki Octobank orqali to\'lashingiz mumkin.',
      ...
      'installment_payment': 'Bo\'lib to\'lash',
      'installment_subtitle': 'Kartadan har oy yechiladi',
      'installment_min_amount':
          'Bo\'lib to\'lash uchun minimal summa 50,000 so\'m',
      'add_card_first': 'Avval karta qo\'shing',
      'select_installment_plan': 'Bo\'lib to\'lash muddatini tanlang',
      'select_card': 'Kartani tanlang',
      'select_period': 'Muddatni tanlang',
      'months': 'oy',
      'per_month': 'oy',
    ...
    'ru': {
      ...
      'delivery_method_title': 'Способ доставки',
      'up_to_3_days': 'До 3 дней',
      'up_to_7_days': 'До 7 дней',
      'not_important': 'Не важно',
      'brand': 'Бренд',
      'brands_plural': 'Бренды',
      'all_items': 'Все',
      'color_label': 'Цвет',
      'size_label': 'Размер',
      'original': 'Оригинал',
      ...
      'image_search_error': 'Ошибка поиска по изображению',
      'empty_favorites_title': 'У вас пока нет\nлюбимых товаров',
      'empty_favorites_subtitle':
          'Вы можете добавить товары, нажав на сердечко в каталоге',
      'empty_favorites_action': 'Смотреть товары',
      'promo_activated': 'Промокод активирован!',
      'promo_use_at_order': 'Используйте при оформлении заказа.',
      ...
      'faq_a5': 'Наличными, через UzCard, Humo или Octobank.',
      ...
      'installment_subtitle': 'Ежемесячное списание с карты',
      'installment_min_amount': 'Минимальная сумма для рассрочки 50 000 сум',
      'add_card_first': 'Сначала добавьте карту',
      'select_installment_plan': 'Выберите срок рассрочки',
